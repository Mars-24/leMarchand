...
Route::group(['prefix' => 'admin', 'middleware' => [Admin::class]], function () {
    ...
    Route::get('/dashboard/2', [\App\Http\Controllers\AdminController::class, 'dashboardOtr'])->name('admin.otr.dashboard');
    ...
    Route::post('/admin/profil/update/{id}', [\App\Http\Controllers\AdminController::class, 'updateProfil'])->name('admin.profil.update.other');
