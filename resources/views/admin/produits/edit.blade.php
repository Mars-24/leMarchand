                                    ...
                                    <div class="ec-vendor-upload-detail">
                                        <form class="row g-3" action="{{route('produits.update',$produit->id)}}" method="POST" enctype="multipart/form-data" onsubmit="handleFormSubmit(event)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control slug-title" id="inputEmail4" name="model" value="{{$produit->model}}"/>
                                            </div>
											<div class="col-md-6">
                                                <label class="form-label">Prix d'achat <span>( En CFA
                                                        )</span></label>
                                                <input type="number" class="form-control" id="price1" name="prix_achat" value="{{$produit->prix_achat}}"/> 
                                            </div>
											<div class="col-md-6">
                                                <label class="form-label">Prix de vente <span>( En CFA
                                                        )</span></label>
                                                <input type="number" class="form-control" id="price2" name="prix_vente" value="{{$produit->prix_vente}}"/>
                                            </div>            
											<div class="col-md-6">
                                                <label class="form-label">Prix minimuin de vente <span>( En CFA
                                                        )</span></label>
                                                <input type="number" class="form-control" id="price3" name="prix_minimum" value="{{$produit->prix_minimum}}"/>
                                            </div>
											<div class="col-md-6">
